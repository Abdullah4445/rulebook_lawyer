    ...
    return GetX<HomeController>(
        ...
        builder: (controller) {
          double walletAmount = double.tryParse(
                  controller.driverModel.value.walletAmount?.toString() ?? '0') ??
              0;
                                  ...
                                  child: RichText(
                                    text: TextSpan(
                                      ...
                                      children: [
                                        ...
                                        TextSpan(
                                          text:
                                              '${Constant.amountShow(amount: Constant.minimumDepositToRideAccept.toString())}',
                                          style: TextStyle(
                                              fontWeight: FontWeight
                                                  .bold), // Optional: Make the amount bold
                                        ),
                                        TextSpan(
                                            text:
