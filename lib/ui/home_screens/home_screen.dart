                              ...
                              child: Padding(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(text: 'You have to minimum '.tr),
                                      TextSpan(
                                        text: '${Constant.amountShow(amount: Constant.minimumDepositToRideAccept.toString())}',
                                        style: TextStyle(fontWeight: FontWeight.bold), // Optional: Make the amount bold
                                      ),
                                      TextSpan(text: ' wallet amount to Accept Order and place a bid'.tr),
                                    ],
                                  ),
                                )
                              ),
