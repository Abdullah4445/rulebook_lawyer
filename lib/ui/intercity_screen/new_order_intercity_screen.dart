...
import 'package:lawyer/controller/intercity_controller.dart';
import 'package:lawyer/model/intercity_order_model.dart';
import 'package:lawyer/model/place_picker_model.dart';
...
import 'package:lawyer/ui/intercity_screen/pacel_details_screen.dart';
import 'package:lawyer/utils/DarkThemeProvider.dart';
import 'package:lawyer/utils/fire_store_utils.dart';
import 'package:lawyer/widget/google_map_search_place.dart';
                                  ...
                                  if (Constant.selectedMapType == 'osm') {
                                    ...
                                    Get.to(const GoogleMapSearchPlacesApi())!
                                      ...
                                      if (value != null) {
                                        ...
                                        controller.sourceCityController.value.text =
                                            placeDetailsModel.result!.vicinity.toString();
                                      }
                                    });
                                  }
                                },
                                            ...
                                            return InkWell(
                                              onTap: () {
                                                if (orderModel.acceptedDriverId != null &&
                                                  ...
                                                  controller.enterOfferRateController
                                                          .value.text =
                                                      orderModel.offerRate.toString();
                                                  offerAcceptDialog(
