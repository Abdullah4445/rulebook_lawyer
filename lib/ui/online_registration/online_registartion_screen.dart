...
import 'package:lawyer/controller/online_registration_controller.dart';
...
import 'package:lawyer/ui/online_registration/details_upload_screen.dart';
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Row(
                                                    children: [
                                                      Expanded(child: Text(Constant().localizationTitle(documentModel.title!,'defaultText'))),
                                                      const SizedBox(
                                                        width: 10,
                                                      ),
