        ...
        builder: (controller) {
          return Scaffold(
            appBar: AppBar(
              ...
              centerTitle: true,
              title: Text(Constant().localizationTitle(controller.documentModel.value.title!,'defaultText'), style: GoogleFonts.poppins(color: Colors.white)),
              leading: InkWell(
                  onTap: () {
                    Get.back();
                  },
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: TextFieldThem.buildTextFiled(context,
                                      hintText: Constant().localizationTitle(controller.documentModel.value.title!,'defaultText'), controller: controller.documentNumberController.value),
                                ),
                                Visibility(
                                ...
                                Visibility(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text("Front Side of ${Constant().localizationTitle(controller.documentModel.value.title!,'defaultText')}".tr, style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600)),
                                        const SizedBox(
                                          height: 10,
                                        ),
                                ...
                                Visibility(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Back side of ${Constant().localizationTitle(controller.documentModel.value.title!,'defaultText')}".tr, style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600)),
                                        const SizedBox(
                                          height: 10,
                                        ),
