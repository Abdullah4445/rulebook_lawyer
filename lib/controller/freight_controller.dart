...
import 'package:lawyer/ui/freight/accepted_freight_orders.dart';
import 'package:lawyer/ui/freight/active_freight_order_screen.dart';
import 'package:lawyer/ui/freight/new_orders_freight_screen.dart';
import 'package:lawyer/ui/freight/order_freight_screen.dart';
      ...
      await FireStoreUtils.getCustomer(orderModel.userId.toString()).then((value) async {
        if (value != null) {
          await SendNotification.sendOneNotification(
              token: value.fcmToken.toString(), title: 'New Bids'.tr, body: 'Lawyer requested your case.'.tr, payload: {});
        }
      });
