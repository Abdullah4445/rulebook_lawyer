...
class AppColors {
  ...
  static const Color darkModePrimary = Color(0xFFE7B64B);
  static const Color brandGold = Color(0xFFE7B64B);
  static const Color brandGoldLight = Color(0xFFFFF4D9);
  static const Color brandNavy = Color(0xFF1D2636);
  static const Color brandSurface = Color(0xFFF8F6F1);
  static const Color brandSurfaceDark = Color(0xFF171717);

  static const Color background = Color(0xffFFFFFF);
  static const Color darkBackground = Color(0xff191B1A);

  static const Color drawerIcon = Color(0xFF8891A4);
  static const Color drawerActive = Color(0xFF1F1F1F);
  static const Color drawerActiveDark = Color(0xFFE7B64B);
